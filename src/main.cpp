...
uint256 hashGenesisBlock("0xf039ecd2ed0a190d71e8d71b475e529dbab78fc70e251105fa7503bc490536b1");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6e7ff0990e47097f72f45917e16dbd5c93f20942268ad56e06f7f1e3b756bf94");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1527240143;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084705542;

        if (fTestNet)
        {
            block.nTime    = 1527240125;
            block.nNonce   = 385448845;
        }
